---
title: The prevalence of child welfare system contact among American Indian / Alaska Native children, 2008 - 2016
...
I use the 2008 - 2016 AFCARS and NCANDS to calculate period life tables for lifetime risk of investigation, substantiation, placement, placement into a non-ICWA compliant foster care settings, and termination of parental rights. Each of these tables provides an estimate of the cumulative risk of experiencing the event before age 18 if risk-levels observed during the reported period remain constant.
...
TO STABILIZE ESTIMATES FOR SMALL AREAS - use a ML bayes model specified 
...
```{r inv, fig.pos="h", out.extra = '', fig.cap = "(A): Risk of maltreatment investigation by age 18, 2008 - 2016 annual period life table. (B): Age-specific risk of first maltreatment investigation, 2012 - 2016 pooled period life table"}
...
ts<-ts + 
  ...
  labs(title = "Risk of event by age 18")

age<-age + 
  theme(legend.position = "bottom",
        axis.title.y = element_blank()) +
  labs(title = "Age-specific risk, pooled")
g<-arrangeGrob(ts, age, ncol  =2)
ggsave("./vis/inv.pdf", g, width = 8, height = 5)
```

Changes in risk of ever-experiencing a maltreatment investigation over time are displayed in Figure \@ref(fig:inv), panel A. Risk for AI/AN children is indicated with the pink line, and white children with a blue line. Underlying risk of maltreatment investigations has shifted for both groups over between 2008 and 2016. For AI/AN children, risk has declined over time from a peak of 0.38 in 2008 to 0.34 in 2016. During this period, risk was at its lowest in 2010 (0.32). Inequality in risk between AI/AN and white children narrowed substantially over this period. In 2008, AI/AN children were 1.37 times more likely than white children to have a screened-in report. In 2016, were 1.05 times more likely than white children to have a screened-in report.
...
```{r sub,  fig.pos="h", out.extra = '', fig.cap = "(A): Risk of substantiated maltreatment investigation by age 18, 2008 - 2016 annual period life table. (B): Age-specific risk of first substantiated maltreatment investigation, 2012 - 2016 pooled period life table"}
### run lifetable by year
subst_tables<-list()
...
age<-age + 
  ...
  labs(title = "Age-specific risk, pooled")
g<-arrangeGrob(ts, age, ncol  =2)
ggsave("./vis/subst.pdf", g, width = 8, height = 5)
...
ggsave("./vis/sub_inv.pdf", width = 8, height = 5)
```
...
age<-age + 
  ...
  labs(title = "Age-specific risk, pooled")
g<-arrangeGrob(ts, age, ncol  =2)
ggsave("./vis/fc.pdf", g, width = 8, height = 5)
...
inv<-inv + 
  theme(legend.position = "bottom") + 
  labs(title = "P(Foster Care | Investigation)")

sub<-sub + 
  theme(legend.position = "bottom",
        axis.title.y = element_blank()) +
  labs(title = "P(Foster Care | Substantiation)")
g<-arrangeGrob(inv, sub, ncol  =2)
ggsave("./vis/fc_cond.pdf", g, width = 8, height = 5)
...
```{r icwa,  fig.pos="h", out.extra = '', fig.cap = "(A): AI/AN risk of ever being placed in non-kin non-AI/AN caretaker foster care by age 18, 2008 - 2016 annual period life table. (B): AI/AN Age-specific risk of being placed in non-kin non-AI/AN caretaker foster care, 2012 - 2016 pooled period life table"}
icwa_tables<-list()
...
age<-age + 
  ...
  labs(title = "Age-specific risk, pooled")
g<-arrangeGrob(ts, age, ncol  =2)
ggsave("./vis/icwa_placement.pdf", g, width = 8, height = 5)
```
...
```{r tpr,   fig.pos="h", out.extra = '', fig.cap = "(A): Risk of termination of parental rights while in foster care by age 18, 2008 - 2016 annual period life table. (B): Age-specific risk of termination of parental rights while in foster care, 2012 - 2016 pooled period life table"}
tpr_tables<-list()
