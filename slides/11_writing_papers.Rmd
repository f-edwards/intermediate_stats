...
- [Rstudio's rmarkdown site with lots of examples and tutorials](https://rmarkdown.rstudio.com/) (link)
- [The cheat sheet](https://www.rstudio.com/wp-content/uploads/2015/02/rmarkdown-cheatsheet.pdf) (link)
...
- enclose math statements with dollar signs ($)
- using two dollar signs starts the equation on a new line
...
```\@ref(regTable)``` makes a numbered reference
