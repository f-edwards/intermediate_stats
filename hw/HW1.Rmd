...
4. Run a linear regression model with the proportion of the population in deep poverty (pop_pct_deep_pov) as a predictor and property tax revenues per capita (prop_tax_pc) as a predictor. 
